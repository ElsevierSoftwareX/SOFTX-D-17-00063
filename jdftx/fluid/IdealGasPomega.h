...
public:
	...
	void getDensities(const DataRptr* logPomega, DataRptr* N, DataRptrVec& P) const;
	double compute(const DataRptr* logPomega, const DataRptr* N, DataRptr* Phi_N, const double Nscale, double& Phi_Nscale) const;
	void convertGradients(const DataRptr* logPomega, const DataRptr* N, const DataRptr* Phi_N, const DataRptrVec& Phi_P, DataRptr* Phi_logPomega, const double Nscale) const;
